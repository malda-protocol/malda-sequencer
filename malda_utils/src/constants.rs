...
pub const USDC_MOCK_MARKET_SEPOLIA: Address = address!("4631d3E5803332448e0D9cBb9bF501A4C50B95ed");
pub const WSTETH_MOCK_MARKET_SEPOLIA: Address = address!("9A3e5153E7642913d007C0685938010011A865C7");
