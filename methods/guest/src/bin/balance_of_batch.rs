...
use guest_utils::{validators::validate_balance_of_call_batch, types::SequencerCommitment};
...
fn main() {
    ...
    validate_balance_of_call_batch(chain_id, account, asset, env_input, sequencer_commitment, env_op_input, linking_blocks);
    }
}
